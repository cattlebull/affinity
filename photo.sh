...
check_dependency "p7zip" # Manjaro uses p7zip instead of 7z
...
wget https://upload.wikimedia.org/wikipedia/commons/f/f5/Affinity_Photo_V2_icon.svg -O "$HOME/.local/share/icons/AffinityPhoto.svg"
...
cat << EOF > "$HOME/.local/share/applications/AffinityPhoto.desktop"
[Desktop Entry]
Name=Affinity Photo
